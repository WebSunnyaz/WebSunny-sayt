  ...
  return (
    ...
    <>
     <Helmet>
      ...
      <div className="grid md:grid-cols-2 gap-10 bg-black primary-border  p-12 rounded-2xl">
        {/* Sol tərəf */}
  ...
  <div className="flex gap-4">
    ...
    >
      <FaWhatsapp className="text-[#28b6ff]" />
        ...
        {/* Sağ tərəf – Form */}
        <form className="bg-[#0b122d] p-6 rounded-2xl flex flex-col gap-4">
          <input
            type="text"
            placeholder="Adınız"
            className="bg-[#0a0f2c] text-white p-3 rounded-lg outline-none focus:ring-2 focus:ring-[#2463eb]"
          />
          <input
            type="email"
          ...
          <textarea
            ...
            className="bg-[#0a0f2c] text-white p-3 rounded-lg outline-none focus:ring-2 focus:ring-[#2463eb] h-56 resize"
          ></textarea>
          <button
            type="submit"
