    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, i) => (
                    <div
                        className="flex bg-[#0a1334] items-center justify-center p-8 text-xl font-semibold text-center border-2 border-[#28b6ff] rounded-[15px] select-none box-border relative gap-7"
                        key={i}
                        style={{
                    ...
                    >
                        <div className="bg-[#0a1334] p-2 rounded-md mb-3 w-16 h-16  flex items-center justify-center">
                            {item.icon}
                        </div>
                        <div>
